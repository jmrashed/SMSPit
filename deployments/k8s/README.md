...
- `HorizontalPodAutoscaler`, `NetworkPolicy`, `PodDisruptionBudget` — deferred; replica counts and resource limits get parameterized via the Helm chart, and hardening is a planned follow-up.
