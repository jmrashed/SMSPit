> Mirrored from [`deployments/k8s/`](https://github.com/jmrashed/SMSPit/tree/main/deployments/k8s/) in the main repo — relative links/paths below refer to that location, not this docs site.
